...
function MainContainer() {
  return (
    <div className="px-[15px] mt-[60px]">
      ...
      <div className="h-[380px] bg-gradient-to-t from-fuchsia-400 to-fuchsia-600 mt-[30px] rounded-lg">
      ...
      <div className="h-[380px] bg-gradient-to-t from-indigo-400 to-indigo-600 mt-[30px] rounded-lg">
        <div className="pl-[20px] pt-[55px]">
          <span className="font-sans text-[24px] font-bold text-slate-100 ">
            For Integrated Safety
          </span>
          <ol className="list-inside list-disc text-slate-100 leading-loose mt-[20px]">
            <li className="underline">112/911 Emergency Services Response System</li>
