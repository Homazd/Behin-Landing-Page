export const products = [
  ...
  },
  {
    ...
    header: "IMS Core",
    groupSubs: [
      { id: "17", header: "Voice over LTE(VoLTE)", link: "/ims/volte" },
      { id: "18", header: "Video over LTE(ViLTE)", link: "/ims/vilte" },
      { id: "19", header: "Voice over New Radio(VoNR)", link: "/ims/vonr" },
      { id: "20", header: "Video over New Radio(ViNR)", link: "/ims/vinr" },
    ],
  },
  {
    id: "4",
...
export const headerProducts = [
  {
    ...
    header: "5GC Core",
    groupSubs: [
      { id: "1.1", header: "AF", link: "/fiveGC/af" },
  ...
  },
  {
    ...
    header: "EPC",
    groupSubs: [
      { id: "12", header: "MME", link: "/epc/mme" },
      { id: "13", header: "HSS", link: "/epc/hss" },
      { id: "14", header: "PCRF", link: "/epc/pcrf" },
      { id: "15", header: "SGW-c", link: "/epc/sgwc" },
      { id: "16", header: "SGW-u", link: "/epc/sgwu" },
    ],
  },
  {
    id: "3",
